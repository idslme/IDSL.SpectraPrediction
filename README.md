...
For a given list of Name, SMILES, InChiKey and ESI Adduct, we can predict the MS/MS spectra using machine learning and QC methods. Those spectra will be uploaded and shared to the zenodo.org database. 
